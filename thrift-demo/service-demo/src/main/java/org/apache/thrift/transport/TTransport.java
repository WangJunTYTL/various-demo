...
/**
 * 网络IO层抽象，Server端和Client使用是相同的IO抽象类，实现类有TSocket、TMemoryBuffer
 *
...
public abstract class TTransport {
    ...
    /**
     * Return the index within the underlying buffer that specifies the next spot that should be
     * read from.
     *
     ...
     *
     * @return the number of bytes remaining in the underlying buffer. <br> Returns -1 if this is a
     * non-buffered transport.
     */
