...
public class TNonblockingServer extends AbstractNonblockingServer {
    ...
    /**
     * The thread that will be doing all the selecting, managing new connections and those that
    ...
    protected class SelectAcceptThread extends AbstractSelectThread {
        ...
        /**
         * Select and process IO events appropriately: If there are connections to be accepted,
         * accept them. If there are existing connections with data waiting to be read, read it,
         * buffering until a whole frame has been read. If there are any pending responses, buffer
