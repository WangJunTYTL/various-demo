...
public abstract class HttpClient {
    ...
    private static String innerGet(String url) {
        ...
        try {
            ...
            try {
                ...
                logger.debug("http protocol:{} statusCode:{} reasonPhrase:{}", new Object[]{statusLine.getProtocolVersion(), statusLine.getStatusCode(), statusLine.getReasonPhrase()});
            ...
            logger.debug("get request url is {}  response data is {}", url, result);
    ...
    public static String post(String url, List<BasicNameValuePair> params) {
        ...
        try {
            ...
            logger.debug("post request url is {} params is " + params + " response data is \n{}", url, result);
            return result == null ? "" : result.trim();
