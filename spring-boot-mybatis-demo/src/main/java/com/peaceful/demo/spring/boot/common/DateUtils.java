...
public class DateUtils {
    public static final SimpleDateFormat SIMPLE_DATETIME_FORMAT = new SimpleDateFormat(
            "yyyy-MM-dd HH:mm:ss");
    ...
    /**
     * 获取某个日期的 开始日期 例子 2008-08-08 12:12:12 返回 2008-08-08 00:00:00.000
     *
     * @return
     */
    ...
    /**
     * 获取某个日期的 结束时间 例子 2008-08-08 12:12:12 返回 2008-08-08 23:59:59.999
     *
     * @return
     */
    ...
    public static Date parseTime(String timeString) {
        Date date = new Date();
        try {
            date = SIMPLE_TIME_FORMAT.parse(timeString);
        } catch (ParseException e) {
